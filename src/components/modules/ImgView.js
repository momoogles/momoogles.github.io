...
const ImgVeiw = ({ imgData, title, link, githubLink }) => {
  const img = () => (
    imgData ? <Img fluid={imgData} /> : (
      <div className="no-image">
        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="images" className="no-img-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    ...
    <div className="img-view">
      ...
      <div className="img-info">
        ...
        <div className="link-wrap">
          {link && (<a href={link} className="site-link"><span>Link</span></a>)}
          {githubLink && (
